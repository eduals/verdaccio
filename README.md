...
Agora a pasta `config/` do repositório é montada diretamente no container:

```yaml
- ./config:/verdaccio/conf
```

Qualquer alteração em `config/config.yaml` pode ser aplicada com redeploy ou restart do container.
